...
int main(int argc, char *argv[]) {
   ...
   *
   */
  plot_data_2d("diffusivity", n1, n2, n3, n1_local, n1_local_offset, 1,
               diffusivity);
  plot_data_2d("diffusivity", n1, n2, n3, n1_local, n1_local_offset, 2,
               diffusivity);
  plot_data_2d("diffusivity", n1, n2, n3, n1_local, n1_local_offset, 3,
               diffusivity);
  ...
  for (istep = 1; istep <= nstep; ++istep) {
    ...
    if (istep % 30 == 1) {
      ...
      plot_data_2d("concentration", n1, n2, n3, n1_local, n1_local_offset, 2,
                   conc);
